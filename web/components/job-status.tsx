...
const STATUS_MAP: Record<string, { label: string; cls: string }> = {
  ...
  running:           { label: "Generating", cls: "bg-blue-500/20 text-blue-400 border-blue-500/30" },
  awaiting_approval: { label: "Awaiting approval", cls: "bg-yellow-500/20 text-yellow-400 border-yellow-500/30" },
